            ...
            <div className="max-w-[1920px] mx-auto px-6 md:px-12 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                    ...
                    <div className="lg:col-span-5">
                        <RevealSection>
                            <h3 className="font-display font-bold text-sm tracking-[0.2em] uppercase text-brand-gold mb-6">Advanced Diagnostics</h3>
                            ...
                            <p className="font-sans text-gray-400 text-lg leading-relaxed mb-10">
                                Vibration is motion. But often, it's too fast or too subtle for the human eye.
                                Powered by <strong className="text-white">RDI Motion Amplification®</strong>, we turn every pixel into a sensor,
                                visualizing structural defects that traditional spectral analysis might miss.
                            </p>
                    ...
                    <div className="lg:col-span-7">
                        <RevealSection delay={0.2}>
                            <div className="relative aspect-video bg-gray-900 border border-white/10 group overflow-hidden">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <div className="text-center">
                                        ...
                                        <p className="font-sans text-xs text-brand-gold uppercase tracking-widest font-bold">Motion Amplification® Demo</p>
                                    </div>
                                </div>
                            ...
                            <div className="mt-4 flex justify-between items-center border-t border-white/10 pt-4">
                                <span className="font-sans text-xs text-gray-500 font-bold">RDI TECHNOLOGIES PARTNER</span>
                                <span className="font-sans text-xs text-brand-gold font-bold">IRIS M™ SYSTEM</span>
                            </div>
                        </RevealSection>
                    </div>
