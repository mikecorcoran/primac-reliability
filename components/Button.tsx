...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  // Use a more natural green accent (emerald -> green)
  const variants = {
    solid: "bg-text-main text-white hover:bg-green-600 hover:text-white",
    ghost: "text-text-main hover:text-green-600 bg-transparent",
    outline: "border border-text-main text-text-main hover:bg-text-main hover:text-white",
    link: "px-0 py-2 text-text-main hover:text-green-600"
  } as const;
