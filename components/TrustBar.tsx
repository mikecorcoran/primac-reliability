            ...
            <div className="relative flex overflow-x-hidden group">
                ...
                >
                    {CLIENTS.map((client, index) => (
                        <span
                            key={index}
                            className="font-display font-black text-2xl md:text-3xl text-gray-200 uppercase tracking-tighter hover:text-brand-accent transition-colors cursor-default select-none"
                        >
                            {client}
                        </span>
                    ))}
