                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {DOCTRINE_POINTS.map((point, index) => (
                        <RevealSection key={point.title} delay={index * 0.1}>
                            <div className="bg-white p-8 h-full border-t-4 border-transparent hover:border-emerald-600 transition-colors duration-300 group shadow-sm hover:shadow-md">
                                <div className="mb-6 h-1 w-12 bg-emerald-600 group-hover:w-16 transition-all duration-300" />
