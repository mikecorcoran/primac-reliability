...
const PROBLEMS = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer a urna sed neque auctor faucibus.",
  ...
  },
  {
    ...
    description:
      "Quisque facilisis, urna non iaculis tristique, mi elit tincidunt leo, ut gravida velit metus in felis.",
...
const METHODOLOGY_STEPS = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur quis felis sagittis, volutpat metus a, egestas nisl.",
  ...
  },
  {
    ...
    title: "Causa Radicis",
    description:
      "Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Integer rhoncus erat id posuere lacinia.",
  ...
  },
  {
    ...
    title: "Verificatio",
    description:
      "Mauris pretium, dui vitae ultricies ultrices, ipsum augue bibendum lectus, at tempus ipsum libero id ipsum.",
